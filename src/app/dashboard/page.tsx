      ...
      <div className="flex items-center space-y-2 gap-2 mb-6">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-muted-foreground">
            Welcome back, {user?.displayName || "Admin"}. Here is what's happening today.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mt-4">
        ...
        <Card className="col-span-4 rounded-none">
          <CardHeader>
            ...
            <CardDescription>
              Your currently running projects and their status.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                <div className="space-y-1">
                  <p className="text-sm font-medium leading-none">Image Campaign '25</p>
          ...
          <Card className="rounded-none border-red-900/20 bg-red-900/5">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium flex items-center text-red-500">
                <AlertCircle className="mr-2 h-4 w-4" /> Attention Needed
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-sm font-medium">Invoice #2024-098</p>
                    <p className="text-xs text-muted-foreground">Overdue by 5 days</p>
                  </div>
