      ...
      <section id="features" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-3xl font-bold text-slate-900">Mehr als nur Rechnungen</h2>
                <p className="mt-4 text-lg text-slate-600">Das Betriebssystem für deinen Unternehmenserfolg.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 mb-3">Zeiterfassung</h3>
                    <p className="text-slate-600">Erfasse deine Arbeitszeit direkt auf Projekte und wandle sie mit einem Klick in eine Rechnung um.</p>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 mb-3">Kundenmanagement (CRM)</h3>
                    <p className="text-slate-600">Alle Kontaktdaten, vergangene Rechnungen und offene Angebote an einem zentralen Ort.</p>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 mb-3">Angebote schreiben</h3>
                    <p className="text-slate-600">Erstelle professionelle Angebote. Wird das Angebot angenommen, wird daraus automatisch eine Rechnung.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-slate-900 rounded-3xl overflow-hidden shadow-2xl relative">
                ...
                <div className="relative z-10 px-8 py-16 text-center md:px-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Bereit für weniger Bürokratie?</h2>
                    ...
                    <p className="mt-6 text-sm text-slate-400">14 Tage kostenlos testen • Jederzeit kündbar</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div className="col-span-1 md:col-span-1">
                    <div className="flex items-center space-x-2 mb-4">
                      <Image src="/logo.png" alt="Logo" width={32} height={32} className="h-8 w-auto" />
                        <span className="font-bold text-lg text-slate-900">RECHNEREI</span>
                    </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-slate-500">
                        <li><a href="#" className="hover:text-blue-600">Funktionen</a></li>
